...
time. The dataset `stock_market_data` has 787 rows of observations and 3
columns that includes variables `year`, `month`, and `close`, giving
stock market closing values between 1950 and 2015 by year and month. For
example, in 1980 the median stock market closing value was 117.954998.
The data from `unemployment_data` has 816 rows of observation and 3
columns that includes variables `year`, `month`, and `unemploy_percent`.
The data was collected for 1948 and 2015. When there was a recession in
2008, the highest unemployment level that year was 7.3%.
